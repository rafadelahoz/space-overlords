...
class ScreenButtons extends FlxSpriteGroup
{
	...
	public function new(X : Float, Y : Float, State : PlayState, BottomHeight : Float)
	{
		...
		add(shootButton = new FlxSprite(0, BottomHeight).loadGraphic("assets/ui/btnLeft.png", true, 90, 40));
		add(downButton = new FlxSprite(halfWidth, BottomHeight).loadGraphic("assets/ui/btnRight.png", true, 90, 40));
